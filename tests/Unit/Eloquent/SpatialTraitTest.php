...
use Thainph\LaravelMysqlSpatial\Exceptions\SpatialFieldsNotDefinedException;
...
class SpatialTraitTest extends BaseTestCase
{
    ...
    public function testInsertUpdateLineStringHasCorrectSql()
    {
        ...
        $this->model->linestring = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdatePolygonHasCorrectSql()
    {
        $point1 = new Point(1, 2);
        $point2 = new Point(2, 3);
        $linestring1 = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point1, $point2]);
        $point3 = new Point(3, 2);
        $point4 = new Point(2, 1);
        $linestring2 = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);

        $this->assertFalse($this->model->exists);

        $this->model->polygon = new \Thainph\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPointHasCorrectSql()
    {
        ...
        $this->model->multipoint = new \Thainph\LaravelMysqlSpatial\Types\MultiPoint([$point1, $point2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiLineStringHasCorrectSql()
    {
        ...
        $this->model->multilinestring = new \Thainph\LaravelMysqlSpatial\Types\MultiLineString([$linestring1, $linestring2]);
        $this->model->save();
    ...
    public function testInsertUpdateMultiPolygonHasCorrectSql()
    {
        ...
        $point4 = new Point(2, 1);
        $linestring2 = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point3, $point4]);
        $polygon1 = new \Thainph\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2]);

        $point5 = new Point(4, 5);
        $point6 = new Point(5, 6);
        $linestring3 = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point5, $point6]);
        $point7 = new Point(6, 5);
        $point8 = new Point(5, 4);
        $linestring4 = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point7, $point8]);
        $polygon2 = new \Thainph\LaravelMysqlSpatial\Types\Polygon([$linestring3, $linestring4]);

        $this->assertFalse($this->model->exists);

        $this->model->multipolygon = new \Thainph\LaravelMysqlSpatial\Types\MultiPolygon([$polygon1, $polygon2]);
        $this->model->save();
    ...
    public function testInsertUpdateGeometryCollectionHasCorrectSql()
    {
        ...
        $linestring1 = new \Thainph\LaravelMysqlSpatial\Types\LineString([$point2, $point3]);

        $this->assertFalse($this->model->exists);

        $this->model->geometrycollection = new \Thainph\LaravelMysqlSpatial\Types\GeometryCollection([$point1, $linestring1]);
        $this->model->save();
    ...
    public function testScopeDistance()
    {
        ...
        $this->assertInstanceOf(\Thainph\LaravelMysqlSpatial\Eloquent\Builder::class, $query);
        $q = $query->getQuery();
    ...
    private function buildTestPolygon()
    {
        ...
        return new \Thainph\LaravelMysqlSpatial\Types\Polygon([$linestring1, $linestring2, $linestring3]);
    }
    ...
    public function testScopeOrderBySpatialThrowsExceptionWhenFunctionNotRegistered()
    {
        $point = new Point(1, 2);
        $this->assertException(
            \Thainph\LaravelMysqlSpatial\Exceptions\UnknownSpatialFunctionException::class,
            'does-not-exist'
        );
